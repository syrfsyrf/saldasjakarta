                ...
                if (!$.trim(data)){   /*
                    ...
                    for(i=0; i<data.length; i++){
                        if (data[i].id == null) {
                            ...
                            '<div class="product">'+
                            '<a href="'+base_url+'assets/frontend/images/dadaayam.jpg" class="img-prod"><img class="img-fluid" src="'+base_url+'assets/frontend/images/dadaayam.jpg" alt="Colorlib Template">'+
