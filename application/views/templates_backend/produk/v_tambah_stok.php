	...
	<form action="<?php echo base_url('data/Data_produk/insertStock'); ?>" method="post">
		<div class="row">
			...
			<div class="col-lg">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<div class="form-group row">
								...
								<div class="col-sm-4">
									<select class="form-control" name="param" readonly>
										<option value=""><?php echo $row->kategori;?></option>
									</select>
								</div>
								<label class="col-sm-2 col-form-label">Nama Produk</label>
								<div class="col-sm-4">
									<input type="text" class="form-control" placeholder="..." value="<?php echo $row->nama_produk;?>" readonly>
							...
							<div class="form-group row">
								...
								<div class="col-sm-12">
									<textarea class="form-control" rows="3" readonly><?php echo $row->deskripsi;?></textarea>
								</div>
							</div>
						</div>
						<!-- /.card-body -->
				...
				<div class="card shadow mb-4">
					...
					<div class="card-body">
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<input type="number" required class="form-control" id="jumlah_stock" name="jumlah_stock" placeholder="..." value="">
							</div>
							<label class="col-sm-2 col-form-label">Tanggal Expired</label>
							<div class="col-sm-4">
								<input type="date" required class="form-control" id="tgl_expired" name="tgl_expired" value="">
							</div>
						</div>
						<div class="form-group row">
							<label for="user" class="col-sm-2 col-form-label">Harga</label>
							<div class="col-sm-4">
								<input type="text" required class="form-control" id="harga" name="harga" placeholder="..." value="">
							</div>
				...
				<div class="card shadow mb-4">
					<button class="btn btn-primary btn-icon-split" type="Submit" id="submit_prod"><span class="text">Submit Stock</span></button>
				</div>
			</div>
		</div>
	</form>
