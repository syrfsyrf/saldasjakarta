	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              	<a class="dropdown-item" href="<?php echo base_url('/main/kategori_produk/daging_sapi'); ?>">Daging Sapi</a>
              	<a class="dropdown-item" href="<?php echo base_url('/main/kategori_produk/daging_ayam'); ?>">Daging Ayam</a>
                <a class="dropdown-item" href="<?php echo base_url('/main/kategori_produk/daging_ikan'); ?>">Daging Ikan</a>
                <a class="dropdown-item" href="<?php echo base_url('/main/kategori_produk/frozen_food'); ?>">Frozen Food</a>
                <a class="dropdown-item" href="<?php echo base_url('/main/kategori_produk/home_made'); ?>">Home Made</a>
              </div> -->
            </li>
              ...
              <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="icon-shopping_cart"></span>[0]</a>
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                <a class="dropdown-item" href="<?php echo base_url('/main/keranjang/v_keranjang'); ?>">Check Out</a>
                <a class="dropdown-item" href="<?php echo base_url('/main/bayar/v_bayar'); ?>">Bayar</a>
              </div>
